...
class TaskCompetionBoard extends StatelessWidget {
  const TaskCompetionBoard({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        constraints: BoxConstraints(minHeight: 180, maxWidth: width),
        ...
        child: AspectRatio(
            aspectRatio: 2.1,
            child: Padding(
              padding: const EdgeInsets.only(top: 25, left: 0, bottom: 15),
              child: LineChart(
                  sampleData1,
